...
{"command": "arm"}
{"command": "disarm"}
{"command": "arm_and_takeoff"}   px4固件起飞到默认高度
{
...
{"command": "set_mode_offboard"}  px4固件为offboard模式  ardupilot固件为guided模式 都是外部控制，统一格式定为 offboard板载模式
{"command": "set_mode_land"}        
{"command": "set_mode_hold"}
{"command": "set_mode_manual"}    px4独有模式，纯手动模式
{"command": "set_mode_altitude"}  px4独有模式
{"command": "set_mode_position"}  px4固件为position模式 ardu_pilot固件为loiter模式  都是定点模式，统一格式定为 position 定点模式
{"command": "set_mode_acro"}	  px4独有模式
{"command": "set_mode_stabilized"}
{"command": "set_mode_position_orbit"}
{"command": "set_mode_auto_mission"}	
{"command": "set_mode_auto_loiter"}	px4独有模式
{"command": "set_mode_auto_rtl"}
{"command": "set_mode_auto_precland"}	px4独有模式
{"command": "set_mode_auto_vtol_takeoff"}	px4独有模式
{"command": "set_mode_external1"}	px4独有模式
{"command": "set_mode_external2"}	px4独有模式
{"command": "set_mode_external3"}	px4独有模式
{"command": "set_mode_external4"}	px4独有模式
